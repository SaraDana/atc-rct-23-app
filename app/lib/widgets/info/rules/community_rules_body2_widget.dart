...
class CommunityRulesBody2Widget extends StatelessWidget {
  final double intraSectionMargin;
  final double listItemsMargin;
  const CommunityRulesBody2Widget({
    Key? key,
    ...
    return Column(
      ...
      children: [
        Align(
            ...
            child: Text(
              '${S.of(context).pageCommunityRulesNumeration2Detail}',
        ...
        Padding(
            ...
            child: UnorderedListItem(
                Text(
                  '${S.of(context).pageCommunityRulesNumeration2DetailPoint1}',
        ...
        Padding(
          ...
          child: UnorderedListItem(
              Text(
                '${S.of(context).pageCommunityRulesNumeration2DetailPoint2}',
                style: bulletContentStyle,
              ),
              bulletStyle),
        ),
