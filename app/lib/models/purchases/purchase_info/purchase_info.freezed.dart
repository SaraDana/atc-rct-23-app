...
/// @nodoc
@JsonSerializable()
class _$_PurchaseInfo implements _PurchaseInfo {
  _$_PurchaseInfo(
      {required this.id,
      required this.title,
  ...
  @override
  String toString() {
    return 'PurchaseInfo(id: $id, title: $title, description: $description, price: $price, rawPrice: $rawPrice, currencyCode: $currencyCode)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, id, title, description, price, rawPrice, currencyCode);
...
abstract class _PurchaseInfo implements PurchaseInfo {
  factory _PurchaseInfo(
      {required final String id,
      required final String title,
      required final String description,
      required final String price,
      required final double rawPrice,
      required final String currencyCode}) = _$_PurchaseInfo;
